...
const ALLOWED_STATUS = new Set(["new", "confirmed", "pending", "completed", "cancelled", "archived"]);
...
export async function GET(req: Request) {
  ...
  const reservations = await db.diningReservation.findMany({ orderBy: { createdAt: "desc" } });
...
export async function DELETE(req: Request) {
  ...
  await db.diningReservation.delete({ where: { id } }).catch(() => null);
