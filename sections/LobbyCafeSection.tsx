...
interface LobbyCafeSectionProps {
  section: SiteContent["lobbyCafeSection"];
}

/**
 * Lobby Café — Cafe in Lobby Area homepage section.
 * Positioned immediately below Fine Dining.
 */
export function LobbyCafeSection({ section }: LobbyCafeSectionProps) {
