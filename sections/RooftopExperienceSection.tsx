...
interface RooftopExperienceSectionProps {
  section: SiteContent["rooftopExperienceSection"];
}

/**
 * Rooftop Experience — Sky Lounge Restaurant & Bar homepage section.
 * Positioned immediately below Lobby Café.
 */
export function RooftopExperienceSection({
  section,
}: RooftopExperienceSectionProps) {
      ...
      <div className="relative mx-auto max-w-[1200px] px-4 py-16 sm:px-6 md:py-20 lg:px-8 lg:py-24">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14 xl:gap-16">
          ...
          >
            ...
            {/* Decorative gold divider with a centered diamond */}
            <motion.div
              variants={luxuryFadeUp}
