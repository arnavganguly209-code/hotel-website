...
export function Header({ header, hotelName }: HeaderProps) {
  ...
  const headerStyle = cn(
    ...
    useTransparent
      ? "border-b border-[#184D3D]/10 bg-gradient-to-r from-[#F6F3E7] via-[#F0F1E3] to-[#E9EEE0] backdrop-blur-xl"
      : "border-b border-[#C89A3D]/10 bg-gradient-to-r from-[#F6F3E7]/95 via-[#F0F1E3]/95 to-[#E9EEE0]/95 shadow-[0_4px_30px_rgba(24,77,61,0.06)] backdrop-blur-xl"
  );
