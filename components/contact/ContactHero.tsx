...
interface ContactHeroProps {
  hero: SiteContent["contactPage"]["hero"];
}
...
export function ContactHero({ hero }: ContactHeroProps) {
  ...
  return (
    <section className="relative flex min-h-[72vh] items-end overflow-hidden md:min-h-[78vh]">
      ...
      <div className="relative z-10 w-full px-6 pb-20 pt-36 text-center lg:px-10 lg:pb-28">
        <motion.nav
        ...
        >
          ...
          <span className="text-[#D4AF37]">{hero.breadcrumbCurrent || "Contact"}</span>
        </motion.nav>
