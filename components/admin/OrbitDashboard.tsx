              ...
              <>
                ...
                <div className="space-y-4 border border-luxury-gold/10 p-6">
                  ...
                  <p className="mt-1 text-xs text-white/40">
                    Homepage Accommodations section (below Cultural Experience). Edit the 3 live room
                    categories below — cover image, price, text, and amenities.
                  </p>
                  <label className="flex items-center gap-3 text-sm text-white/70">
                    <input
                      type="checkbox"
                ...
                <OrbitRoomsEditor
                  ...
                  onRoomsChange={(rooms) => update("rooms", rooms)}
                  onLibraryChange={(mediaLibrary) => update("mediaLibrary", mediaLibrary)}
                />
