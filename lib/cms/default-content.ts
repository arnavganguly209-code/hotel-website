...
export const defaultContent: SiteContent = {
  ...
  footer: {
    ...
    enabledPayments: [],
    paymentLogos: [
      { id: "pay1", src: "/media/payments/01-visa.png?v=official2" },
      { id: "pay2", src: "/media/payments/02-mastercard.png?v=official2" },
      { id: "pay3", src: "/media/payments/03-unionpay.png?v=official2" },
      { id: "pay4", src: "/media/payments/04-alipay.png?v=official2" },
      { id: "pay5", src: "/media/payments/05-upi.png?v=official2" },
      { id: "pay6", src: "/media/payments/06-esewa.png?v=official2" },
    ],
