...
}> = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Direct booking often unlocks flexible rates, late checkout requests, and spa add-ons. Explore <a href=\"/rooms\">rooms at Hotel Thamel Park</a>, then refine with our <a href=\"/spa\">spa experiences</a> and <a href=\"/dining\">restaurants</a>.",
        ],
      },
    ],
    faq: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Book popular rooftops on weekends. In-house guests can reserve through reception — start at our <a href=\"/dining\">restaurant page</a>.",
        ],
      },
    ],
    faq: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Book spa rituals, reserve dinner, or plan weddings and conferences. Visit <a href=\"/spa\">Spa</a>, <a href=\"/dining\">Restaurant</a>, and <a href=\"/meetings-events\">Meetings &amp; Events</a>.",
        ],
      },
      {
        id: "how-to-book",
