...
export const OFFICIAL_PAYMENT_LOGOS = [
  { id: "pay1", src: "/media/payments/01-visa.png?v=official2", label: "Visa" },
  { id: "pay2", src: "/media/payments/02-mastercard.png?v=official2", label: "Mastercard" },
  { id: "pay3", src: "/media/payments/03-unionpay.png?v=official2", label: "UnionPay" },
  { id: "pay4", src: "/media/payments/04-alipay.png?v=official2", label: "Alipay" },
  { id: "pay5", src: "/media/payments/05-upi.png?v=official2", label: "UPI" },
  { id: "pay6", src: "/media/payments/06-esewa.png?v=official2", label: "eSewa" },
] as const;
