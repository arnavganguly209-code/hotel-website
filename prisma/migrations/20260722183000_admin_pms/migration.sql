-- AlterTable
ALTER TABLE "Booking" ADD COLUMN IF NOT EXISTS "roomSlug" TEXT NOT NULL DEFAULT '';
ALTER TABLE "Booking" ADD COLUMN IF NOT EXISTS "roomName" TEXT NOT NULL DEFAULT '';
ALTER TABLE "Booking" ADD COLUMN IF NOT EXISTS "breakfast" TEXT NOT NULL DEFAULT 'room-only';
